...
public class AwfulUI
{
    ...
    private Vector2 UI_Position_16 = new Vector2(0, 380);
    ...
    public void Draw()
    {
        ...
        Globals.Sprite_Batch.DrawString(Font, "Brush Size: " + GameCore.ScrollValue/2, UI_Position_4, UI_Color);
        ...
        Globals.Sprite_Batch.DrawString(Font, "Time: " + GameCore.TimeCycle.CurrentTimeOfDay, UI_Position_13, UI_Color);
        Globals.Sprite_Batch.DrawString(Font, GameCore.TimeCycle.GetNextTimeOfDay(GameCore.TimeCycle.CurrentTimeOfDay) + " in: " + (int)(GameCore.TimeCycle.CycleDuration - GameCore.TimeCycle.Time)/60, UI_Position_14, UI_Color);

        Globals.Sprite_Batch.DrawString(Font, "Controlling Lag? " + LagMonitor.CONTROLLING_LAG, UI_Position_15, UI_Color);
