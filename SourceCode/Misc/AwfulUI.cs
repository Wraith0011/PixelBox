...
public class AwfulUI
{
    ...
    private Vector2 UI_Position_13 = new Vector2(0, 260);
    private Vector2 UI_Position_14 = new Vector2(0, 280);
    private Vector2 UI_Position_15 = new Vector2(0, 300);
    private Vector2 UI_Position_16 = new Vector2(0, 320);
    private Vector2 UI_Position_17 = new Vector2(0, 340);
    private Vector2 UI_Position_18 = new Vector2(0, 380);

    public AwfulUI(GameCore game_core, LagMonitor lag_monitor)
    {
        GameCore = game_core;
        Font = game_core.Font;
        GameWorld = game_core.GameWorld;
        LagMonitor = lag_monitor;
    }

    public void Draw()
    {
        Globals.Sprite_Batch.DrawString(Font, "FPS: " + (int)Globals.FPS, UI_Position_0, UI_Color);
        Globals.Sprite_Batch.DrawString(Font, "Selected: " + GameCore.SelectedCellType.ToString(), UI_Position_2, UI_Color);
        ...
        Globals.Sprite_Batch.DrawString(Font, "Lightning Cells: " + GameWorld.LightningCells.Count, UI_Position_12, UI_Color);

        Globals.Sprite_Batch.DrawString(Font, "Time: " + GameCore.TimeCycle.CurrentTimeOfDay, UI_Position_14, UI_Color);
        Globals.Sprite_Batch.DrawString(Font, GameCore.TimeCycle.GetNextTimeOfDay(GameCore.TimeCycle.CurrentTimeOfDay) + " in: " + (int)(GameCore.TimeCycle.CycleDuration - GameCore.TimeCycle.Time)/60, UI_Position_15, UI_Color);
        Globals.Sprite_Batch.DrawString(Font, "Raining?: " + WeatherCycle.IsRaining, UI_Position_16, UI_Color);
        
        Globals.Sprite_Batch.DrawString(Font, "Controlling Lag? " + LagMonitor.CONTROLLING_LAG, UI_Position_18, UI_Color);
